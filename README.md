...
Check the [test
case](https://github.com/xpendit/xstate-machine/blob/master/tests/testapp/tests/test_state_transitions.py)
...
- Implement Transition \_\_hash\_\_ and \_\_eq\_\_ for \'in\' operator
